...
ship_string =       os.path.join(".", "sprites", "small ship right.png")
impact_string =     os.path.join(".", "sprites", "impactspritesheet.png")
incoming_string =   os.path.join(".", "sprites", "roundshipspin.png")
missile_string =    os.path.join(".", "sprites", "missile right.png")
background_string = os.path.join(".", "sprites", "skyscrolling.jpg")
